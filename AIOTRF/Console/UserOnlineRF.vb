...
#Region "call"
    Public Sub calldata()
        ...
        Try
            perintah = New SqlCommand("SELECT Name,LastConnTime from tbl_general", ConnWorld.conworldc)
    ...
    Private Sub Load_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LoadOnline.Tick
        Refresh()
        calldata()
